...
public class ConstStrings {
    ...
    public static final String sharedPreferences_passwordKey = "password";

    public static final String wrongRegistrationLine = "Поля регистрации заполнены не верно.";
    public static final String wrongCode = "Введен не верный код.";
}
